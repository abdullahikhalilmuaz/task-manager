        ...
        {[
          {
            ...
            desc: "Focus on what matters most with intelligent suggestions.",
          },
          {
            icon: <FiTrendingUp />,
            title: "Track Progress",
            desc: "Monitor your tasks and measure your productivity.",
          },
          {
            icon: <FiUsers />,
            title: "Team Collaboration",
            desc: "Work together and achieve more as a team.",
          },
          {
            icon: <FiPieChart />,
            title: "Beautiful Analytics",
            desc: "Get insights and improve your performance.",
          },
        ].map((f) => (
